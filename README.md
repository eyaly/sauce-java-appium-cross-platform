...
2. Select (1) Actions tab -> (2) Click on "Real Devices" (3) Click "Run workflow" and (4) Run workflow
   <img src="./graphics/run_github_actions.png" alt="runGitHubActions" width="800" height="400"/>   
3. GitHub Actions starts to run
   <img src="./graphics/start_running_githubActions.png" alt="startRunGitHubActions" width="800" height="400"/>
4. You should see four test executions running in Sauce Labs platform
   <img src="./graphics/run_sauceLabs.png" alt="runningGitHubActions" width="400" height="200"/>    
5. Wait till the tests passed
   <img src="./graphics/test_run_passed.png" alt="passedRunGitHubActions" width="400" height="200"/>    
